  ...
  "data": [
    {
      "proposalSummarySection": [
        {
          "Section7-0": "(PrefixProponent): There should be nothing here from overlay",
          "Section8-0": "(PrefixProponent): GOLDFIELDS, SOUTH COAST",
          "Section9-0": "(Proponent Answer Text). (PrefixProponent):"
        }
      ]
    }
  ],
  "layer_data": [
    {
      ...
      "sqs_timestamp": "2023-03-15 11:25:40"
    },
    {
      "name": "Section8-0",
      "label": None,
      ...
      "sqs_timestamp": "2023-03-15 11:25:41"
    },
    {
      "name": "Section9-0",
      "label": None,
